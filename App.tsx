...
function App() {
    ...
    const handlePhotoFromCamera = (imageDataUrl: string) => {
                    ...
                    {appState === 'idle' && (
                        <div className="relative flex flex-col items-center justify-center w-full">
                            ...
                            >
                                ...
                                <div className="my-4 text-neutral-600 font-permanent-marker tracking-widest">OR</div>

                                <button onClick={() => setIsCameraOpen(true)} className={`${secondaryButtonClasses} flex items-center gap-3`}>
